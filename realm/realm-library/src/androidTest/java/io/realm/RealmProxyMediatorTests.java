...
public class RealmProxyMediatorTests {
    ...
    public void validateTable_noDuplicateIndexInIndexFields() {
        ...
        CatRealmProxy.CatColumnInfo columnInfo = (CatRealmProxy.CatColumnInfo) mediator.createColumnInfo(Cat.class, realm.sharedRealm);
    ...
    public void validateTable_noDuplicateIndexInIndicesMap() {
        ...
        columnInfo = (CatRealmProxy.CatColumnInfo) mediator.createColumnInfo(Cat.class, realm.sharedRealm);
